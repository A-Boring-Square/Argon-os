...
""")
print(" ")
print("press Enter to open the text editor WIP")
...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    self.root = root
    # Title of the window
    self.root.title("Argon text editor")
    # Window Geometry
    ...
    # Initializing Status
    self.status.set("Welcome To Argon text editor")
    # Creating Menubar
  ...
  def infoabout(self):
    messagebox.showinfo("About Text Editor","Argon-EDIT is a simple text editor included with the Argon-OS")
